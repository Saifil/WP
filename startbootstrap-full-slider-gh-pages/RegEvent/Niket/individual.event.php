        ...
        <nav class="black">
          <div class="nav-wrapper">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down" style="padding-right:2%;">
              <li><a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Profile" href="profile.php"><i class="large material-icons">perm_identity</i></a></li>              <li><a href="#"><i class="large material-icons">search</i></a></li>
        ...
        <div class="grey lighten-2">
          <div class="row nsclass">
            ...
            <div class="col s6 nsclass11" style="padding-left: 30px;">
                ...
                <div class="row"><h5><i class="material-icons">thumb_up</i>  &nbsp Interested:<?=$row["e_interested"]?></h5></div>
            </div>
          </div>
        </div>
          <!-- end Main Section -->
