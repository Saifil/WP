    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url("k.png");"></div>
...
<!--create event modal-->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <span class="lefttext">Event Name :</span>
            <input type="text" name="event" class="form-control" id="modalinputs" placeholder="Event Location" width="80%">
  ...
  <div class="col-sm-4">
    ...
    <img class="card-img-top" src="k.png" alt="Card image cap">
      <div class="card-block">
        <h3 class="card-title">Special title treatment</h3>
        <p class="card-text">With supporting text below as a natural lead-in to add to additional content.</p>
        <a href="#" class="btn btn-primary">Go somewhere</a>
      </div>
    </div>
  </div>
