<?php
  ...
  $sql = "SELECT * FROM event WHERE eid = $e_id;";
...
<body>
<div style="background: url('<?=$row["img"]?>') 50% 50% no-repeat;background-size: cover;color: #fff; opacity: 1;" class="banner pad-top-45 pad-bottom-45 pad-top-60-m pad-bottom-60-m">
      <div class="container text-center pad-top-20-m pad-bottom-20-m pad-top-55-l pad-bottom-55-l">
      <h1 id="logo" class="logo" style="color: white; font-variant-caps: all-small-caps;" >
          <?=$row["event"]?>
        </h1>
    <h2 class="banner-heading" style="color: white;">
